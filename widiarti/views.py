...
from cahyani.models import Transaksi, DetailTransaksi
...
from cahyani.forms import CahyaniAddProductForm
from cahyani.keranjang import Cahyani
import datetime
...
def beranda(request):
    ...
    cahyani_product_form = CahyaniAddProductForm()
    context = { "judul": "Halaman Beranda",
                "kategori" : kategori, 
                "jumlahkategori":jumlahkategori,
                "slide": slider,
                "trending":trending,
                "cahyani_product_form": cahyani_product_form,
